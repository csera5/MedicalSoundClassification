...
np.savetxt("newTrain.csv", newTrainingData, delimiter=",", fmt="%d", header=header, comments="")
np.savetxt("newTest.csv", newTestingData, delimiter=",", fmt="%d", header=header, comments="")